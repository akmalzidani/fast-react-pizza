      ...
      <Form method="post">
        ...
        <div className="relative flex flex-col gap-2 mb-5 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[35px] sm:top-[3px] z-50 md:right-[5px] md:top-[5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
        ...
        <div className="flex items-center gap-5 mb-12">
          <input
            className="w-6 h-6 accent-yellow-600 focus:outline-none focus:ring focus:ring-yellow-400 focus:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
...
export async function action({ request }) {
  ...
  // If there are no errors, proceed to create the order
